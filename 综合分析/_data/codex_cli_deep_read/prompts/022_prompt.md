...
正文包信息：
- 正文来源：综合分析\_data\full_text_cache_plain\022.txt
- 原始字符数：87721
- 本次发送字符数：87721
- 是否截断：False
...
Int. J. Network Mgmt 2014; 00:1–24
Published online in Wiley InterScience (www.interscience.wiley.com). DOI: 10.1002/nem

A Survey of Methods for Encrypted Traffic
Classification and Analysis
Petr Velan∗† , Milan Čermák, Pavel Čeleda, Martin Drašar
...
KEY WORDS: encrypted traffic; monitoring; network; traffic classification; traffic analysis; machine
learning; encryption protocols
...
Correspondence to: Institute of Computer Science, Masaryk University, Botanická 68a, Brno, Czech Republic
Email: velan@ics.muni.cz
...
Before any further analysis of encrypted network traffic can be done, the traffic needs to be
...
international conferences such as IMC, PAM, CISDA, CNSM, IM and NOMS over the period 20052014. Other methods were found in references provided by the surveyed papers and in papers that
referenced them.
...
provided by these encryption protocols. Most protocols negotiate encryption algorithms in cleartext, these data can be monitored, e.g., to reveal the use of weak ciphers. Third, we describe how
...
Copyright c 2014 John Wiley & Sons, Ltd.
Prepared using nemauth.cls

Int. J. Network Mgmt (2014)
DOI: 10.1002/nem
...
This paper is organized into seven sections. Section 2 explains the principles of several widely
...
and consists of different sub-protocols, as well as configurable and replaceable cryptographic
algorithms [55].
...
packet structure, which is depicted in Figure 4. The MAC code is computed on a plaintext payload
...
When TCP is used, the connection is usually established over port 80 or 443, which masks Skype
...
This makes it possible to passively distinguish specific operating systems, web browsers and other
...
Traffic features' measurement Level
...
Figure 6. A multilevel taxonomy of traffic classification methods [48].
Classification Input
Traffic Payload
...
Traffic Properties
Host
number of connections, opened ports
(Measurement Level)
Flow
...
combination of inputs, external knowledge
Table I. Classification input level.
Classification Technique
Payload Inspection
DPI, examination of first N bytes
Graphlets
relationship between features (ports, addresses)
Graphical
Motifs
...
Basic Statistical
probability density functions of e.g. packet sizes
Statistical
Heuristics
port-based classification
Method
Profiles
host profiling, usage of packet sizes and direction
Supervised
Hidden Markov Models, Naive Bayes, k-nearest
Machine Learning
neighbour, support vector machine
Algorithm
Non-Supervised
clustering of unlabeled traffic, k-nearest neighbour
Semi-Supervised
clustering of mixed traffic, k-nearest neighbour
Reinforcement Learning
Hybrid & Miscellaneous
combination of methods, external knowledge
...
Classification Output
Traffic Objects
host community is assigned a class, e.g., community of HTTP servers
host is assigned a class
flow is assigned a class
packet is assigned a class
Traffic Classes
bulk or small transactions
game, browsing, chat
HTTP, HTTPS, FTP
client software such as Mail client, FTP client or web browser
Skype voice call, Google search, Facebook chat
port scan, brute-force attack
combination of outputs or classes, external knowledge
...
nDPI [27] is an open-source classifier forked from the (currently closed) project OpenDPI, which
...
6. FEATURE-BASED TRAFFIC CLASSIFICATION TECHNIQUES FOR ENCRYPTED
TRAFFIC
...
the accuracy of the k-means clustering algorithm for classifying encrypted traffic. The authors test
...
Figure 7. A visual representation of transport-layer interactions for various applications [44].
...
reported. The system allows for the customization of malicious sequences’ definitions using a subgoals characterization. Each sub-goal maps to a malicious event, such as data gathering or system
...
Encrypted protocol ident.

Table IV. A summary table of cited papers and methods they use to detect encrypted traffic.
...
genetic algorithms to find the best setting. The authors of [68, 47] use the entropy of packet
...
concern. This discussion resulted in a new RFC [31], where the IETF clearly states that pervasive
...
This material is based on the work supported by the Security Research for the Needs of the State 2010-2015
programme funded by the Ministry of the Interior of the Czech Republic.

REFERENCES
1. D. Adami, C. Callegar, S. Giordano, M. Pagano, and T. Pepe. Skype-Hunter: A real-time system for the detection
and classification of Skype traffic. International Journal of Communication Systems, 25(3), February 2011.
2. S. Alcock and R. Nelson. Libprotoident: Traffic Classification Using Lightweight Packet Inspection. Online article,
2012. Accessed: 2014-11-26.
3. E. Alpaydin. Introduction to Machine Learning. The MIT Press, 2nd edition, 2010.
4. R. Alshammari, P.I. Lichodzijewski, M. Heywood, and A.N. Zincir-Heywood. Classifying SSH Encrypted Traffic
with Minimum Packet Header Features Using Genetic Programming. In Proceedings of the 11th Annual Conference
Companion on Genetic and Evolutionary Computation Conference: Late Breaking Papers, GECCO ’09, pages
2539–2546, New York, NY, USA, 2009. ACM.
5. R. Alshammari and A.N. Zincir-Heywood. A Flow Based Approach for SSH Traffic Detection. In Systems, Man
and Cybernetics, 2007. ISIC. IEEE International Conference on, pages 296–301, Oct 2007.
6. R. Alshammari and A.N. Zincir-Heywood. A Preliminary Performance Comparison of Two Feature Sets for
Encrypted Traffic Classification. In Proceedings of the International Workshop on Computational Intelligence
in Security for Information Systems CISIS’08, volume 53 of Advances in Soft Computing, pages 203–210. Springer
Berlin Heidelberg, 2009.
7. R. Alshammari and A.N. Zincir-Heywood. Machine learning based encrypted traffic classification: Identifying
SSH and Skype. In Computational Intelligence for Security and Defense Applications, 2009. CISDA 2009. IEEE
Symposium on, pages 1–8, July 2009.
8. R. Alshammari and A.N. Zincir-Heywood. An Investigation on the Identification of VoIP traffic: Case study on
Gtalk and Skype. In Network and Service Management (CNSM), 2010 International Conference on, pages 310–
313, Oct 2010.
9. R. Alshammari and A.N. Zincir-Heywood. Can encrypted traffic be identified without port numbers, IP addresses
and payload inspection? Computer Networks, 55(6):1326 – 1350, 2011.
10. P.V. Amoli and T. Hamalainen. A Real Time Unsupervised NIDS for Detecting Unknown and Encrypted Network
Attacks in High Speed Network. In Measurements and Networking Proceedings (M N), 2013 IEEE International
Workshop on, pages 149–154, Oct 2013.
11. D.J. Arndt and A.N. Zincir-Heywood. A Comparison of Three Machine Learning Techniques for Encrypted
Network Traffic Analysis. In Computational Intelligence for Security and Defense Applications (CISDA), 2011
IEEE Symposium on, pages 107–114, April 2011.
12. Azureus Software Inc. Message Stream Encryption. Vuze Wiki. Web page, May 2014. Accessed: 2014-10-31.
13. C. Bacquet, A.N. Zincir-Heywood, and M.I. Heywood. An Investigation of Multi-objective Genetic Algorithms
for Encrypted Traffic Identification. In Computational Intelligence in Security for Information Systems, volume 63
of Advances in Intelligent and Soft Computing, pages 93–100. Springer Berlin Heidelberg, 2009.
14. C. Bacquet, A.N. Zincir-Heywood, and M.I. Heywood. Genetic Optimization and Hierarchical Clustering Applied
to Encrypted Traffic Identification. In Computational Intelligence in Cyber Security (CICS), 2011 IEEE Symposium
on, pages 194–201, April 2011.
15. R. Bar-Yanai, M. Langberg, D. Peleg, and L. Roditty. Realtime Classification for Encrypted Traffic. In
Experimental Algorithms, volume 6049 of Lecture Notes in Computer Science, pages 373–385. Springer Berlin
Heidelberg, 2010.
Copyright c 2014 John Wiley & Sons, Ltd.
Prepared using nemauth.cls
...
16. L. Bernaille and R. Teixeira. Early Recognition of Encrypted Applications. In Proceedings of the 8th International
Conference on Passive and Active Network Measurement, PAM’07, pages 165–175, Berlin, Heidelberg, 2007.
Springer-Verlag.
17. S. Blake-Wilson, M. Nystrom, D. Hopwood, J. Mikkelsen, and T. Wright. Transport Layer Security (TLS)
Extensions. RFC 4366 (Proposed Standard), April 2006. Obsoleted by RFCs 5246, 6066, updated by RFC 5746.
18. T. Bujlow, V. Carela-Español, and P. Barlet-Ros. Independent comparison of popular DPI tools for traffic
classification. Computer Networks, 76(0):75 – 89, 2015.
19. CAIDA. Cyber-security Research Ethics Dialog & Strategy Workshop, May 2013. Accessed: 2014-12-03.
20. A. Callado, C. Kamienski, G. Szabo, B. Gero, J. Kelner, S. Fernandes, and D. Sadok. A Survey on Internet Traffic
Identification. Communications Surveys & Tutorials, IEEE, 11(3):37–52, rd 2009.
21. Z. Cao, G. Xiong, Y. Zhao, Z. Li, and L. Guo. A Survey on Encrypted Traffic Classification. In Lynn Batten, Gang
Li, Wenjia Niu, and Matthew Warren, editors, Applications and Techniques in Information Security, volume 490 of
Communications in Computer and Information Science, pages 73–81. Springer Berlin Heidelberg, 2014.
22. Cisco Systems, Inc. Network Based Application Recognition (NBAR). Web page, 2014. Accessed: 2014-11-25.
23. ClearFoundation. l7-filter. Web page, October 2013. Accessed: 2014-11-26.
24. D. Cooper, S. Santesson, S. Farrell, S. Boeyen, R. Housley, and W. Polk. Internet X.509 Public Key Infrastructure
Certificate and Certificate Revocation List (CRL) Profile. RFC 5280 (Proposed Standard), May 2008. Updated by
RFC 6818.
25. A Dainotti, A Pescape, and K.C. Claffy. Issues and Future Directions in Traffic Classification. Network, IEEE,
26(1):35–40, January 2012.
26. A. De Montigny-Leboeuf. Flow attributes for use in traffic characterization. Communications Research Centre
Canada, Tech. Rep, 2005.
27. L. Deri, M. Martinelli, T. Bujlow, and A. Cardigliano. nDPI: Open-source high-speed deep packet inspection.
In Wireless Communications and Mobile Computing Conference (IWCMC), 2014 International, pages 617–622,
August 2014.
28. T. Dierks and E. Rescorla. The Transport Layer Security (TLS) Protocol Version 1.2. RFC 5246 (Proposed
Standard), August 2008. Updated by RFCs 5746, 5878, 6176.
29. Y. Du and R. Zhang. Design of a Method for Encrypted P2P Traffic Identification Using K-means Algorithm.
Telecommunication Systems, 53(1):163–168, 2013.
30. Z. Durumeric, J. Kasten, M. Bailey, and J.A. Halderman. Analysis of the HTTPS Certificate Ecosystem. In
Proceedings of the 2013 Conference on Internet Measurement Conference, IMC ’13, pages 291–304, New York,
NY, USA, 2013. ACM.
31. S. Farrell and H.b Tschofenig. Pervasive Monitoring Is an Attack. RFC 7258 (Best Current Practice), May 2014.
32. M. Finsterbusch, C. Richter, E. Rocha, J.-A. Muller, and K. Hanssgen. A Survey of Payload-Based Traffic
Classification Approaches. Communications Surveys & Tutorials, IEEE, 16(2):1135–1156, Second 2014.
33. S.E. Frankel, K. Kent, R. Lewkowski, A.D. Orebaugh, R.W. Ritchey, and S.R. Sharma. SP 800-77. Guide to IPsec
VPNs. Technical report, National Institute of Standards & Technology, Gaithersburg, MD, United States, 2005.
34. A. Freier, P. Karlton, and P. Kocher. The Secure Sockets Layer (SSL) Protocol Version 3.0. RFC 6101 (Historic),
August 2011.
35. J. Galbraith and O. Saarenmaa. SSH File Transfer Protocol draft-ietf-secsh-filexfer-13.txt. Internet-Draft, July
2006.
36. D. Harrison. Index of BitTorrent Enhancement Proposals. Web page, October 2014. Accessed: 2014-11-27.
37. L. Hellemons, L. Hendriks, R. Hofstede, A. Sperotto, R. Sadre, and A. Pras. SSHCure: A Flow-Based SSH
Intrusion Detection System. In Dependable Networks and Services, volume 7279 of Lecture Notes in Computer
Science, pages 86–97. Springer Berlin Heidelberg, 2012.
38. R. Holz, L. Braun, N. Kammenhuber, and G. Carle. The SSL Landscape: A Thorough Analysis of the X.509 PKI
Using Active and Passive Measurements. In Proceedings of the 2011 ACM SIGCOMM Conference on Internet
Measurement Conference, IMC ’11, pages 427–444, New York, NY, USA, 2011. ACM.
39. L. Huang, S. Adhikarla, D. Boneh, and C. Jackson. An Experimental Study of TLS Forward Secrecy Deployments.
Internet Computing, IEEE, 18(6):43–51, November 2014.
40. IANA - Internet Assigned Numbers Authority. Protocol Registries. Web page, 2014. Accessed: 2014-11-28.
41. IETF. IETF 88 Proceedings, Technical Plenary, 2014. Accessed: 2014-12-03.
42. ipoque GmbH. PACE 2.0. Web page. Accessed: 2014-11-25.
43. ISO. ISO/IEC 7498-1:1994 Information technology – Open Systems Interconnection – Basic Reference Model: The
Basic Model. International Organization for Standardization, Geneva, Switzerland, 2 edition, November 1994.
44. T. Karagiannis, K. Papagiannaki, and M. Faloutsos. BLINC: Multilevel Traffic Classification in the Dark. In
...
Communications, SIGCOMM ’05, pages 229–240, New York, NY, USA, 2005. ACM.
45. C. Kaufman, P. Hoffman, Y. Nir, and P. Eronen. Internet Key Exchange Protocol Version 2 (IKEv2). RFC 5996
(Proposed Standard), September 2010. Updated by RFCs 5998, 6989.
46. S. Kent. IP Encapsulating Security Payload (ESP). RFC 4303 (Proposed Standard), December 2005.
47. A.R. Khakpour and A.X. Liu. An Information-Theoretical Approach to High-Speed Flow Nature Identification.
Networking, IEEE/ACM Transactions on, 21(4):1076–1089, Aug 2013.
48. J. Khalife, A. Hajjar, and J. Diaz-Verdejo. A multilevel taxonomy and requirements for an optimal trafficclassification model. International Journal of Network Management, 24(2):101–120, 2014.
49. R. Koch and G.D. Rodosek. Command Evaluation in Encrypted Remote Sessions. In Proceedings of the 2010
Fourth International Conference on Network and System Security, NSS ’10, pages 299–305, Washington, DC,
USA, 2010. IEEE Computer Society.
50. M. Korczynski and A. Duda. Classifying Service Flows in the Encrypted Skype Traffic. In Communications (ICC),
2012 IEEE International Conference on, pages 1064–1068, June 2012.
51. M. Korczynski and A. Duda. Markov Chain Fingerprinting to Classify Encrypted Traffic. In INFOCOM, 2014
Proceedings IEEE, pages 781–789, April 2014.
52. Y. Kumano, S. Ata, N. Nakamura, Y. Nakahira, and I Oka. Towards real-time processing for application
identification of encrypted traffic. In Computing, Networking and Communications (ICNC), 2014 International
Conference on, pages 136–140, Feb 2014.
53. G. Maiolini, A. Baiocchi, A. Iacovazzi, and A. Rizzi. Real Time Identification of SSH Encrypted Application Flows
by Using Cluster Analysis Techniques. In Luigi Fratta, Henning Schulzrinne, Yutaka Takahashi, and Otto Spaniol,
editors, NETWORKING 2009, volume 5550 of Lecture Notes in Computer Science, pages 182–194. Springer Berlin
Heidelberg, 2009.
54. M. Majkowski. SSL fingerprinting for p0f. Web page, June 2012. Accessed: 2014-11-28.
55. C. Meyer. 20 Years of SSL/TLS Research An Analysis of the Internet’s Security Foundation. PhD thesis, RuhrUniversity Bochum, February 2014.
56. B. Miller, L. Huang, A.D. Joseph, and J.D. Tygar. I Know Why You Went to the Clinic: Risks and Realization of
HTTPS Traffic Analysis. In Privacy Enhancing Technologies, volume 8555 of Lecture Notes in Computer Science,
pages 143–163. Springer International Publishing, 2014.
57. A. Moore, M. Crogan, and D. Zuev. Discriminators for use in flow-based classification. Technical report, Queen
Mary, University of London, 2005.
58. T.T.T. Nguyen and G. Armitage. A Survey of Techniques for Internet Traffic Classification Using Machine
Learning. Communications Surveys & Tutorials, IEEE, 10(4):56–76, October 2008.
59. Y. Okada, S. Ata, N. Nakamura, Y. Nakahira, and I Oka. Application Identification from Encrypted Traffic Based on
Characteristic Changes by Encryption. In Communications Quality and Reliability (CQR), 2011 IEEE International
Workshop Technical Committee on, pages 1–6, May 2011.
60. J. Pechanec. How the SCP protocol works. Jan Pechanec’s Weblog. Weblog post, July 2007. Accessed: 2014-1030.
61. Qualys, Inc. HTTP Client Fingerprinting Using SSL Handshake Analysis. Web page, 2014. Accessed: 2014-1128.
62. Sandvine, Inc. Global Internet Phenomena Report 1H 2014, May 2014. Accessed: 2014-11-25.
63. Skype and Microsoft. Skype. Web page, 2014. Accessed: 2014-11-25.
64. Skype Limited. Skype ConnectTM Requirements Guide. Online, 2011. Accessed: 2014-11-01.
65. sslbl.abuse.ch. SSL Blacklist. Web page, 2014. Accessed: 2014-11-28.
66. W. Stallings. Protocol Basics: Secure Shell Protocol. The Internet Protocol Journal, 12(4), December 2009.
67. G. Sun, Y. Xue, Y. Dong, D. Wang, and C. Li. An Novel Hybrid Method for Effectively Classifying Encrypted
Traffic. In Global Telecommunications Conference (GLOBECOM 2010), 2010 IEEE, pages 1–5, Dec 2010.
68. Y. Wang, Z. Zhang, L. Guo, and S. Li. Using Entropy to Classify Traffic More Deeply. In Networking, Architecture
and Storage (NAS), 2011 6th IEEE International Conference on, pages 45–52, July 2011.
69. C.V. Wright, F. Monrose, and G.M. Masson. On Inferring Application Protocol Behaviors in Encrypted Network
Traffic. J. Mach. Learn. Res., 7:2745–2769, December 2006.
70. T. Ylonen and C. Lonvick. The Secure Shell (SSH) Transport Layer Protocol. RFC 4253 (Proposed Standard),
January 2006. Updated by RFC 6668.
71. M. Zhang, W. John, KC Claffy, and N. Brownlee. State of the Art in Traffic Classification: A Research Review. In
PAM ’09: 10th International Conference on Passive and Active Measurement, Student Workshop, 2009.
72. M. Zhang, H. Zhang, B. Zhang, and G. Lu. Encrypted Traffic Classification Based on an Improved Clustering
Algorithm. In Trustworthy Computing and Services, volume 320 of Communications in Computer and Information
Science, pages 124–131. Springer Berlin Heidelberg, 2013.
Copyright c 2014 John Wiley & Sons, Ltd.
Prepared using nemauth.cls
