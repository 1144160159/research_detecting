...
- **原始题名**：Untangling Attribution: Moving to Accountability in Cyberspace
- **题名中文释义**：Untangling Attribution： Moving to Accountability 在 Cyberspace
- **年份**：2010
- **DOI**：无
- **来源/会议期刊**：Council on Foreign Relations prepared statement
- **PDF**：`paper/Untangling%20Attribution%20-%20Moving%20to%20Accountability%20in%20Cyberspace.pdf`
- **大类**：基础理论、密码协议与安全机制
- **二级关联**：无
- **相关性**：弱相关（分数 0）
- **代码状态**：未发现；无
...
- **全文抽取状态**：缓存 `full_text_cache_plain/016.txt`，约 0 字符；去除参考文献后的正文约 0 字符。
