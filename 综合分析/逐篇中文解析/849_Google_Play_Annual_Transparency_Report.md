...
- **原始题名**：Google Play Annual Transparency Report
- **题名中文释义**：Google Play Annual Transparency Report
- **年份**：2025
- **DOI**：无
- **来源/会议期刊**：Google Transparency Report
- **PDF**：`paper/Google%20Play%20Annual%20Transparency%20Report.pdf`
- **大类**：数据集、基准、综述与开源工具
- **二级关联**：无
- **相关性**：弱相关（分数 0）
- **代码状态**：未发现；无
...
- **全文抽取状态**：缓存 `full_text_cache_plain/849.txt`，约 0 字符；去除参考文献后的正文约 0 字符。
