...
- **原始题名**：Bro: a system for detecting network intruders in real-time
- **题名中文释义**：Bro： a 系统 面向 detecting 网络 intruders 在 实时
- **年份**：1999
...
- **全文抽取状态**：缓存 `full_text_cache_plain/006.txt`，约 0 字符；去除参考文献后的正文约 0 字符。
...
- 方法命名/系统缩写：Bro，可作为检索代码、复现材料和同类工作的关键锚点。
