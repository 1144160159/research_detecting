...
def get_pgd_adv_features(orig_feature, model, label, total_repeat_time, iters, alpha):
    ...
    # print(label)
    # print("---")
    # print([model.predict(x) for x in pgd_adv_features_list])
...
asset_model_dir = os.path.join("../../../../", "asset", "pants-app-end-host", args.asset_name)
...
f1 = f1_score(prediction_results, ground_truth_results, average="weighted")
print(f"Original testing accuracy: {accuracy}, f1: {f1}")
