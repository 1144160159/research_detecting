...
# print(len(correct_sample_idx_set) / len(idx_test))
...
l = f"Transferability mlp -> cnn: {sum(visited.values()) / len(visited.values())}"
print(l)

with open(os.path.join(args.folder, "mlp_to_cnn.txt"), "w") as file:
    file.write(l)
