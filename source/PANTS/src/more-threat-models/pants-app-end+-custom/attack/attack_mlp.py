...
parser.add_argument("--append", type=int, help="Append")
parser.add_argument("--inject", type=int, help="Inject")
parser.add_argument("--split", type=int, help="Split")

# Parse the arguments
args = parser.parse_args()

OVERHEAD = args.delay * 0.01
PKT_PAYLOAD_APPEND_LIMIT = args.append * 0.01
MAX_NUM_PKTS = args.inject
PKT_SPLIT_LIMIT = args.split * 0.01
...
f1 = f1_score(
    np.argmax(prediction_results, axis=1), ground_truth_results, average="weighted"
)
