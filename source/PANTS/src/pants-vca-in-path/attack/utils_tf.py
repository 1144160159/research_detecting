...
def get_pgd_adv_features(orig_feature, labels, model, loss, total_repeat_time, iters, alpha, normalized_max_pkt_len, normalized_min_pkt_len):
    ...
    for iteration in range(total_repeat_time*iters):
        ...
        for i in range(mask.size(1)):
            if mask[0, i, 0] == 1 and sign_grad[0, i, 0] < 0:
                sign_grad[0, i, 0] = 0
            if mask[0, i, 0] == 1 and sign_grad[0, i, 1] < 0:
                sign_grad[0, i, 1] = 0   
