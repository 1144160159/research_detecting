...
class SPOT:
    ...
    def __init__(self, q=1e-4):
        ...
        self.data = None
        self.init_data = None
        self.init_threshold = None          #训练集选的初始阈值
        self.peaks = None
        self.n = 0
        self.Nt = 0
    ...
    def initialize(self, level=0.98, min_extrema=False, verbose=True):
        ...
        # initial peaks
        self.peaks = self.init_data[self.init_data > self.init_threshold] - self.init_threshold         #训练集中超过初始阈值的值集合
    ...
    def _quantile(self, gamma, sigma):
        ...
        if gamma != 0:
            ...
            res = self.init_threshold - sigma * log(r)
            return res
