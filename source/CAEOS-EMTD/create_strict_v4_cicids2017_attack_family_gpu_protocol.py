...
STAGE_SEEDS = {
    "development": (17,),
    "confirmation": (953, 967, 971),
}
DEVELOPMENT_STATE = "complete_seed17_attack_family_gpu_development"
    ...
    *,
    ...
    if stage == "confirmation":
        ...
        development = load_canonical(
            development_result_path, "GPU attack-family development result"
        )
        if (
            development.get("state") != DEVELOPMENT_STATE
            or development.get("claim_boundary", {}).get("authorized_level")
            != "attack_family"
            or not development.get("gpu_execution", {}).get("all_tasks_passed")
        ):
            raise ValueError("invalid GPU attack-family development result")
        ...
        selection_source = {
            ...
            "selection_seed": STAGE_SEEDS["development"][0],
        }
    ...
    protocol: dict[str, Any] = {
        "schema_version": "strict_v4_cicids2017_attack_family_gpu_protocol_v1",
        "state": f"frozen_zero_result_{stage}",
        "stage": stage,
        "suite": "cicids2017_attack_family_gpu",
        "authorized_level": "attack_family",
        "benign_family": "Benign",
        "fine_to_family": FINE_TO_FAMILY,
        "scenarios": FAMILY_SCENARIOS,
        "seeds": list(seeds),
        "development_seed": STAGE_SEEDS["development"][0],
        ...
        "pairwise_caeos": {
            ...
            "risk_policy_name": "strict_v4_attack_family_pairwise_caeos_gpu_v1",
        ...
        "xgboost_known_expert": {
            ...
            "task_must_emit_passing_gpu_execution": True,
        },
        ...
        "claim_boundary": {
            ...
            "development_labels_may_select_configuration": stage == "development",
            "confirmation_test_or_unknown_labels_may_select_nothing": True,
            "xgboost_known_expert_training_uses_cuda": True,
            "pairwise_caeos_component_uses_cpu": True,
            "data_preparation_and_metrics_may_use_cpu": True,
            "all_model_training_is_gpu": False,
...
def main() -> None:
    ...
    parser.add_argument("--stage", choices=tuple(STAGE_SEEDS), required=True)
