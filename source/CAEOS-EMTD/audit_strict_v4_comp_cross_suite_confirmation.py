...
def build_audit(
    *,
    ...
    if (
        ...
        raise ValueError("canonical cross-suite summary required")
    expected_tasks = {
    ...
    pairwise = independently_recompute(records, "caeos_comp", "pairwise")
    opendetect = independently_recompute(
        records, "caeos_comp", "opendetect"
    )
    ...
    checks = independently_recompute_checks(
    ...
    integrity_checks = {
        ...
        "decision_checks_independently_reconcile": decision_reconciles,
    ...
    result: dict[str, Any] = {
        ...
        "selection": {
            ...
            "selected_algorithm": (
                "caeos_comp" if integrity_passes and effect_passes else "pairwise"
            ),
        },
        ...
        "implementation_sha256": {
            "audit_strict_v4_comp_cross_suite_confirmation.py": auditor_sha256
        },
        "claim_boundary": {
            "audit_selection_is_limited_to_strict_v4_accuracy_scope": True,
            "external_malicious_parrot_deployment_and_efficiency_still_required": True,
            "bootstrap_values_are_schema_checked_not_independently_resampled": True,
            "no_universal_sota_claim_is_authorized": True,
        },
    }
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "results/strict_v4_comp_cross_suite_confirmation_v1/audit.json"
        ),
    )
...
def main() -> None:
    ...
    audit = build_audit(
        ...
        input_file_sha256={
            str(protocol_path.relative_to(root)): file_hash(protocol_path),
            str(summary_path.relative_to(root)): file_hash(summary_path),
        },
