...
Test-label oracle neural upper bound: 0.672633; this is diagnostic only and is not a deployable baseline.
...
Test-label oracle neural upper bound: 0.891241; this is diagnostic only and is not a deployable baseline.
