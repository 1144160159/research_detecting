...
PROTOCOL_ROOT="$PROJECT_ROOT/results/strict_v4_final_efficiency_protocol_v4"
PLAN_ROOT="$PROJECT_ROOT/results/strict_v4_final_efficiency_execution_plan_v4"
FORMAL_ROOT="$PROJECT_ROOT/runs/strict_v4_final_efficiency_v4"
SUMMARY_ROOT="$PROJECT_ROOT/results/strict_v4_final_efficiency_v4"
...
if ! mkdir "$LOCK_DIR" 2>/dev/null; then
  echo "efficiency v4 recovery already active" >&2
  exit 0
fi
