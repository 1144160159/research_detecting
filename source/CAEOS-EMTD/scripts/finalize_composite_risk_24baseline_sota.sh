...
COMPOSITE_ROOT="${COMPOSITE_ROOT:-/opt/data/private/wangwt/ParkAttackKE/CAEOS-EMTD-strict-v4-20260717}"
PYTHON="${PYTHON:-/opt/data/private/wangwt/anaconda3/envs/py3.9/bin/python}"
GATE="${GATE:-$COMPOSITE_ROOT/runs/final_composite_risk_gate_5seed}"
SELECTION="${SELECTION:-$COMPOSITE_ROOT/results/final_composite_risk_selection/selection.json}"
...
OUTPUT="${OUTPUT:-$PROJECT_ROOT/results/final_composite_risk_24baseline_sota}"
...
"$PYTHON" audit_classical_ood_reports.py \
  --root "$CLASSICAL" --expected-runs 190 \
