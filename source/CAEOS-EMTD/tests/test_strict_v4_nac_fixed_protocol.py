...
from create_strict_v4_nac_fixed_expansion_gate import create_gate
from run_strict_v4_nac_fixed_matrix import select_pilot_scenarios


class StrictV4NACFixedProtocolTests(unittest.TestCase):
    ...
    def test_gate_binds_protocol_and_requires_zero_results(self):
        protocol = {
            "schema_version": "strict_v4_mlp_nac_ue_fixed_protocol_v1", "mode": "pilot", "expected_runs": 14,
            "fit_data": "class_balanced_known_training_features_only", "ood_parameter_sweep": False,
        }
