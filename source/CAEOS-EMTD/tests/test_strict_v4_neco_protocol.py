...
from create_strict_v4_neco_expansion_gate import create_gate
from run_strict_v4_neco_matrix import select_pilot_scenarios


class StrictV4NECOProtocolTests(unittest.TestCase):
    ...
    def test_gate_binds_protocol_and_requires_zero_results(self):
        protocol = {
            "schema_version": "strict_v4_mlp_neco_id90_protocol_v1", "mode": "pilot", "expected_runs": 14,
