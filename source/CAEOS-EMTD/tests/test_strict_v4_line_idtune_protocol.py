...
from create_strict_v4_line_idtune_expansion_gate import create_gate
from run_strict_v4_line_idtune_matrix import select_pilot_scenarios


class StrictV4LINeIDTuneProtocolTests(unittest.TestCase):
    ...
    def test_gate_binds_protocol_and_requires_zero_results(self):
        protocol = {
            "schema_version": "strict_v4_mlp_line_idtune_protocol_v1", "mode": "pilot", "expected_runs": 14,
            "fit_data": "known_training_features_labels_and_known_validation_only", "ood_parameter_sweep": False,
        }
