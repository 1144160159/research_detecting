...
from create_strict_v4_complementary_training_pilot_protocol import (
    METHODS,
    create_gate,
    create_protocol,
)
...
class ComplementaryTrainingPilotProtocolTests(unittest.TestCase):
    ...
    def test_protocol_and_gate_are_canonical_and_zero_result_frozen(self) -> None:
        ...
        self.assertEqual(protocol["expected_runs"], 56)
    ...
    def test_protocol_rejects_scenario_outside_registry(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            coverage["scenario_registry"]["nf_unsw"]["scenarios"] = ["generic"]
