...
def evaluate(args: argparse.Namespace) -> dict[str, Any]:
    completion = load_canonical(
        args.completion.resolve(), "DMC-CAEOS CUDA completion"
    )
    if (
        ...
        raise ValueError("DMC-CAEOS CUDA completion did not pass")
    source = {}
    task_sources = {}
    ...
    result: dict[str, Any] = {
        "schema_version": (
            "strict_v4_dual_metric_contrastive_development_evaluation_v1"
        ),
        "state": (
