...
def build_protocol(
    *,
    ...
    if (
        ...
        raise ValueError("complete CUDA XGBoost anchors are required")
    if (
    ...
    if output_root.exists() and any(output_root.iterdir()):
        raise ValueError("binary output root must be new or empty")
    ...
    implementation_names = (
        ...
        "run_strict_v4_fine_binary_warning_development.py",
        "evaluate_strict_v4_fine_binary_warning_development.py",
    )
    xgboost = parent["training"]["xgboost_cuda"]
    protocol: dict[str, Any] = {
        "schema_version": (
            "strict_v4_fine_binary_warning_development_protocol_v1"
        ),
        "state": "frozen_before_binary_effect",
        ...
        "training": {
            ...
            "xgboost_root": xgboost["package_root"],
            "required_gpu_uuid": parent["resource_contract"][
                "required_gpu_uuid"
            ],
            "estimators": xgboost["estimators"],
            ...
            "jobs_per_task": xgboost["jobs_per_task"],
        ...
        "claim_boundary": {
            "qualification_unknown_results_informed_binary_head_choice": True,
            "current_seeds_are_adaptive_development_only": True,
            "unknown_or_test_labels_not_read_at_protocol_freeze": True,
            "binary_threshold_uses_known_only_validation": True,
