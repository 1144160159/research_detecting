...
#FINETUNED_PATH_MODEL="/home/mboffa/mboffa_storage/Giovanni/models/pre_train_stage/TrainingQAdenoiser0450K_QA_hard_mean_seed43_512/task-supervised_lr-0.0005_epochs-20_batch-24/seed_43/best_model"
MODEL_NAME="T5-base"
...
#Input info
TRAINING_DATA="../../1.Datasets/QA/Train_Easy.parquet"
TEST_DATA="../../1.Datasets/QA/Test_Easy.parquet"
...
for i in 0
do
    IDENTIFIER="Denoiser0450K_QA_Hard_mean_seed${SEED[i]}_512_40_TLS_MIX"
    export SCRIPT_ARGS=" \
