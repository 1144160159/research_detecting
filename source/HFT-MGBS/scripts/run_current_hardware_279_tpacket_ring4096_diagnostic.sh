...
readonly default_config=/home/wangwt/phase_2/code/HFT-MGBS/configs/current_hardware_2_79_tpacket_ring4096_diagnostic.json
...
expected = {
    ...
    ("candidate_id",): "TPACKET_QM_RING4096_GEOMETRY_FULL_PIPELINE_DIAGNOSTIC",
    ...
    ("pipeline", "block_size"): 4096,
    ("pipeline", "block_count"): 4096,
    ("pipeline", "frame_size"): 256,
    ("pipeline", "retire_block_timeout_ms"): 1,
...
setsid "${frozen_binary}" \
  ...
  --block-size 4096 --block-count 4096 --frame-size 256 \
