...
readonly default_config=/home/wangwt/phase_2/code/HFT-MGBS/configs/current_hardware_2_79_tpacket_fixed64_rxusecs12_timerpaced_burst64_ratep5469_diagnostic.json
...
expected = {
    ...
    ("traffic", "clone_skb"): 8,
    ("traffic", "burst"): 64,
    ("traffic", "ratep_per_burst_call"): 5469,
    ("traffic", "expected_delay_ns"): 182848,
