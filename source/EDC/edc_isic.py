...
if __name__ == "__main__":
    ...
    parser.add_argument('-sn', '--save_name', type=str,
                        default='edcad_isic_256224_r50_r50_m4_bn99_adamw1e4wd1e4_1e5_b32_i5h_cl1_mean_0',
                        )
    ...
    Data Configurations
    '''
    parser.add_argument('--data_dir', type=str, default="/data/disk2T1/guoj/ISIC2018")
