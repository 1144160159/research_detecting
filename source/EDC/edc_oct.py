...
if __name__ == "__main__":
    ...
    parser.add_argument('-sn', '--save_name', type=str,
                        default='ecdad_oct_256_r50_r50_m4_bn99_adamw5e4wd1e4_1e5_b32_i6k_cl1_0',
                        )
    ...
    Data Configurations
    '''
    parser.add_argument('--data_dir', type=str, default="/data/disk2T1/jialz/OCT2017")
    parser.add_argument('-ds', '--dataset', type=str, default='oct')
