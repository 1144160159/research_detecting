...
------------      -------    --------    -----------
2024/7/26 10:52   xueying      1.0       在模型更新后，再进行评估，主要是把identify drift的代码挪到这里来了，把对certain和uncertain update后的代码都集中到这一个文件中，通过参数控制
'''
...
class UpdateEvaluateConfig:
    def __init__(self, config_folder, data_folder, used_config, ori_seq_num, ori_sta_num, certain_seq_num,
                 ...
                 execute_folder_name='6_ctu_script_new',
                 update_part_name='p2', update_part_folder='p1p2_uncertain', is_usesl='no', eval_part_name='p1val',
                 old_dataset_beishu_uncertain=1.0, old_dataset_beishu_certain=1.0, uncertain_update_way='dist_center', refine_uncertain=''):
        """
        ...
        if self.dataset == 'ctu' and used_config == 'config1':
        ...
        elif self.eval_part_name == 'p2val':
        ...
        elif self.eval_part_name == 'p4val':
        ...
        self.ori_file_root = f'/home/hxy/driftDetect/0_data/2_captured_traffic/ctu_all_run_data/{data_folder}'
        ...
        self.result_root = f'/home/hxy/driftDetect/newcode0625/{execute_folder_name}/result/{update_part_folder}/{config_folder}/{update_part_name}_updated/{self.tmp_mid_folder}/{eval_part_name}'
        self.test_save_data_root = f'/home/hxy/driftDetect/newcode0625/{execute_folder_name}/save_data/{update_part_folder}/{config_folder}/{update_part_name}_updated/{self.tmp_mid_folder}/{eval_part_name}'
