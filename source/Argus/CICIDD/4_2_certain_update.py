...
# -*- encoding: utf-8 -*-
'''
@File    :   4_2_certain_update.py
@Contact :   hanxueying@iie.ac.cn
@License :   (C)Copyright 2017-2018, Liugroup-NLPR-CASIA

@Modify Time      @Author    @Version    @Desciption
------------      -------    --------    -----------
2024/8/16 10:58   xueying      1.0       
'''
...
class UpdateCertainConfig:
    def __init__(self, used_config, config_folder, data_folder, model_folder, new_normal_file, new_attack_file,
        ...
        self.certain_update_test_save_data_root_p2valnew = f'/home/hxy/driftDetect/newcode0625/{execute_folder_name}/save_data/p1{self.old_test_part_name}_certain/{self.config_folder}/{self.old_test_part_name}_updated/{certain_update_tmp_folder_name}/p2valnew'
        self.certain_update_test_result_root_p2valnew = f'/home/hxy/driftDetect/newcode0625/{execute_folder_name}/result/p1{self.old_test_part_name}_certain/{self.config_folder}/{self.old_test_part_name}_updated/{certain_update_tmp_folder_name}/p2valnew'
        self.certain_update_test_save_data_root_p4valnew = f'/home/hxy/driftDetect/newcode0625/{execute_folder_name}/save_data/p1{self.old_test_part_name}_certain/{self.config_folder}/{self.old_test_part_name}_updated/{certain_update_tmp_folder_name}/p4valnew'
        self.certain_update_test_result_root_p4valnew = f'/home/hxy/driftDetect/newcode0625/{execute_folder_name}/result/p1{self.old_test_part_name}_certain/{self.config_folder}/{self.old_test_part_name}_updated/{certain_update_tmp_folder_name}/p4valnew'
