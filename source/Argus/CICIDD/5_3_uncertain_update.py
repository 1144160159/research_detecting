...
# -*- encoding: utf-8 -*-
'''
@File    :   5_3_uncertain_update.py
@Contact :   hanxueying@iie.ac.cn
@License :   (C)Copyright 2017-2018, Liugroup-NLPR-CASIA

@Modify Time      @Author    @Version    @Desciption
------------      -------    --------    -----------
2024/8/16 14:30   xueying      1.0       
'''
...
class UpdateUncertainConfig:
    def __init__(self, used_config, config_folder, data_folder, new_normal_file, new_attack_file, old_test_part_name,
        ...
        self.ori_file_root = f'/home/hxy/driftDetect/0_data/1_cicids2018/4_ids_all_run_data/{self.data_folder}'
        ...
        self.certain_model_root = f'/home/hxy/driftDetect/newcode0625/{execute_folder_name}/model/p1{self.old_test_part_name}_certain/{self.config_folder}/certain_usesl_{self.used_self_labeled_data_certain}_codb{self.codb}_om{used_seq_model_ori_num}_{used_sta_model_ori_num}'  # 不涉及cm，所以这里单独写
        # 在certain更新的时候，在训练过程中直接保存了簇心这些，所以这里只使用了new文件夹，（7.29）
        self.certain_save_data_root = f'/home/hxy/driftDetect/newcode0625/{execute_folder_name}/save_data/p1{self.old_test_part_name}_certain/{self.config_folder}/{certain_update_tmp_folder_name}/{self.old_test_part_name}_new'
        ...
        self.uncertain_updated_test_result_root_p2valnew = f'/home/hxy/driftDetect/newcode0625/{execute_folder_name}/result/p1{self.old_test_part_name}_uncertain/{self.config_folder}/{self.old_test_part_name}_updated/{uncertain_update_tmp_folder_name}/p2valnew'
        self.uncertain_update_test_save_data_root_p2valnew = f'/home/hxy/driftDetect/newcode0625/{execute_folder_name}/save_data/p1{self.old_test_part_name}_uncertain/{self.config_folder}/{self.old_test_part_name}_updated/{uncertain_update_tmp_folder_name}/p2valnew'
        self.uncertain_updated_test_result_root_p4valnew = f'/home/hxy/driftDetect/newcode0625/{execute_folder_name}/result/p1{self.old_test_part_name}_uncertain/{self.config_folder}/{self.old_test_part_name}_updated/{uncertain_update_tmp_folder_name}/p4valnew'
        self.uncertain_update_test_save_data_root_p4valnew = f'/home/hxy/driftDetect/newcode0625/{execute_folder_name}/save_data/p1{self.old_test_part_name}_uncertain/{self.config_folder}/{self.old_test_part_name}_updated/{uncertain_update_tmp_folder_name}/p4valnew'
