...
class _CodeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_Code.ValueType], builtins.type):
    ...
    ARCHITECTURE_FIT_NOT_IMPLEMENTED: _Code.ValueType  # 5
    PROP_NOT_IMPLEMENTED: _Code.ValueType  # 6
...
ARCHITECTURE_FIT_NOT_IMPLEMENTED: Code.ValueType  # 5
PROP_NOT_IMPLEMENTED: Code.ValueType  # 6
global___Code = Code
...
class ServerMessage(google.protobuf.message.Message):
    ...
    @typing.final
    class PropIns(google.protobuf.message.Message):
        DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    @typing.final
    class ArchitectureFitIns(google.protobuf.message.Message):
        DESCRIPTOR: google.protobuf.descriptor.Descriptor
        ...
        @typing.final
        class FeaturesMappingEntry(google.protobuf.message.Message):
            DESCRIPTOR: google.protobuf.descriptor.Descriptor
        ...
        CONFIG_FIELD_NUMBER: builtins.int
        FEATURES_MAPPING_FIELD_NUMBER: builtins.int
        @property
        def parameters(self) -> global___Parameters: ...
        @property
        def model_architecture(self) -> global___Scalar: ...
        @property
        def config(self) -> google.protobuf.internal.containers.MessageMap[builtins.str, global___Scalar]: ...
        @property
        def features_mapping(self) -> google.protobuf.internal.containers.MessageMap[builtins.str, global___Scalar]: ...
        def __init__(
            self,
            *,
            parameters: global___Parameters | None = ...,
            model_architecture: global___Scalar | None = ...,
            config: collections.abc.Mapping[builtins.str, global___Scalar] | None = ...,
            features_mapping: collections.abc.Mapping[builtins.str, global___Scalar] | None = ...,
        ) -> None: ...
        def HasField(self, field_name: typing.Literal["model_architecture", b"model_architecture", "parameters", b"parameters"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["config", b"config", "features_mapping", b"features_mapping", "model_architecture", b"model_architecture", "parameters", b"parameters"]) -> None: ...
    ...
    PROP_INS_FIELD_NUMBER: builtins.int
    ARCHITECTURE_FIT_INS_FIELD_NUMBER: builtins.int
    @property
    ...
    @property
    def prop_ins(self) -> global___ServerMessage.PropIns:
        """Added"""

    @property
    def architecture_fit_ins(self) -> global___ServerMessage.ArchitectureFitIns: ...
    def __init__(
        self,
        *,
        ...
        prop_ins: global___ServerMessage.PropIns | None = ...,
        architecture_fit_ins: global___ServerMessage.ArchitectureFitIns | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["architecture_fit_ins", b"architecture_fit_ins", "evaluate_ins", b"evaluate_ins", "fit_ins", b"fit_ins", "get_parameters_ins", b"get_parameters_ins", "get_properties_ins", b"get_properties_ins", "msg", b"msg", "prop_ins", b"prop_ins", "reconnect_ins", b"reconnect_ins"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["architecture_fit_ins", b"architecture_fit_ins", "evaluate_ins", b"evaluate_ins", "fit_ins", b"fit_ins", "get_parameters_ins", b"get_parameters_ins", "get_properties_ins", b"get_properties_ins", "msg", b"msg", "prop_ins", b"prop_ins", "reconnect_ins", b"reconnect_ins"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["msg", b"msg"]) -> typing.Literal["reconnect_ins", "get_properties_ins", "get_parameters_ins", "fit_ins", "evaluate_ins", "prop_ins", "architecture_fit_ins"] | None: ...
...
class ClientMessage(google.protobuf.message.Message):
    ...
    @typing.final
    class PropRes(google.protobuf.message.Message):
        DESCRIPTOR: google.protobuf.descriptor.Descriptor

        @typing.final
        class ProposalsEntry(google.protobuf.message.Message):
            DESCRIPTOR: google.protobuf.descriptor.Descriptor
        ...
        def status(self) -> global___Status: ...
        @property
        def proposals(self) -> google.protobuf.internal.containers.MessageMap[builtins.str, global___Scalar]: ...
        def __init__(
            self,
            *,
            status: global___Status | None = ...,
            proposals: collections.abc.Mapping[builtins.str, global___Scalar] | None = ...,
        ) -> None: ...
        def HasField(self, field_name: typing.Literal["status", b"status"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["proposals", b"proposals", "status", b"status"]) -> None: ...
    ...
    PROP_RES_FIELD_NUMBER: builtins.int
    @property
    ...
    @property
    def prop_res(self) -> global___ClientMessage.PropRes:
        """Added"""
    ...
    def __init__(
        ...
        *,
        ...
        prop_res: global___ClientMessage.PropRes | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["disconnect_res", b"disconnect_res", "evaluate_res", b"evaluate_res", "fit_res", b"fit_res", "get_parameters_res", b"get_parameters_res", "get_properties_res", b"get_properties_res", "msg", b"msg", "prop_res", b"prop_res"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["disconnect_res", b"disconnect_res", "evaluate_res", b"evaluate_res", "fit_res", b"fit_res", "get_parameters_res", b"get_parameters_res", "get_properties_res", b"get_properties_res", "msg", b"msg", "prop_res", b"prop_res"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["msg", b"msg"]) -> typing.Literal["disconnect_res", "get_properties_res", "get_parameters_res", "fit_res", "evaluate_res", "prop_res"] | None: ...
...
class Scalar(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["bool", b"bool", "bytes", b"bytes", "double", b"double", "scalar", b"scalar", "sint64", b"sint64", "string", b"string"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["bool", b"bool", "bytes", b"bytes", "double", b"double", "scalar", b"scalar", "sint64", b"sint64", "string", b"string"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["scalar", b"scalar"]) -> typing.Literal["double", "sint64", "bool", "string", "bytes"] | None: ...
