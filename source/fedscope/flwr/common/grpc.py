...
def create_channel(
    ...
    channel_options = [
        ...
        #("grpc.keepalive_time_ms",20),
        #("grpc.arg_keepalive_timeout_ms",7200000 )
        ('grpc.keepalive_time_ms', 600000),  # 10 minutes between pings
        ('grpc.keepalive_timeout_ms', 0),  # Disable timeout on pings
