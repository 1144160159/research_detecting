...
class Code(Enum):
    ...
    ARCHITECTURE_FIT_NOT_IMPLEMENTED = 5
...
class PropRes:
    status: Status
    proposal: Dict[str, Scalar] =None
@dataclass
class PropIns:
      config: Dict[str, Scalar] =None
@dataclass
class ArchitectureFitIns:
    model_architecture: Scalar
    parameters: Parameters
    features_mapping : Dict[str, Scalar] =None
    config : Dict[str, Scalar] =None
...
class ServerMessage:
    ...
    prop_ins: Optional[PropIns] = None
    architecture_fit_ins : Optional[ArchitectureFitIns]=None
...
class ClientMessage:
    ...
    prop_res: Optional[PropRes] = None
