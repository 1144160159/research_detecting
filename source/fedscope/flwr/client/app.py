...
def start_client(
    *,
    ...
    client_id : Optional[str] = None  #used for logging purpose
) -> None:
    ...
    while True:
        ...
        with connection(
            ...
            while True:
                ...
                #log(INFO,"Received: %s message id=%s"message.metadata.message_type, message.metadata.message_id[0:5])
                log(INFO,f"[{time.time()}] [{message.metadata.message_type}]")
