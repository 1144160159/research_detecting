...
def start_server(  # pylint: disable=too-many-arguments,too-many-locals
    *,
    ...
    # Initialize server and server config, initialized_config is now always equals to configs
    # In the original flower, config can be optional and in this place it's initialized
    initialized_server= init_defaults(
        server=server,
        config=config,
        strategy=strategy,
    ...
    log(
        INFO,
        "Starting Flower Server: gRPC server running (rounds = %s, load_checkpoint=%s), SSL is %s",
        initialized_server.server_config.num_rounds,
        initialized_server.server_config.load_checkpoint,
