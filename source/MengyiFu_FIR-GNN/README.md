...
@ARTICLE{10915555,
  ...
  number={2},
  pages={4892-4902},
  keywords={Smart homes;Feature extraction;Logic gates;Security;Graph neural networks;Consumer electronics;Training;Network intrusion detection;Deep learning;Telecommunication traffic;Network intrusion detection;graph neural networks;smart home gateways;graph attention networks;consumer electronics},
