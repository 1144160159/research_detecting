...
Run dir: F:\泉城实验室\二期\论文\异常检测\output\image-to-editable-ppt\20260706-212634-codex_ppt_园区网络流量智能检测与分析专题汇报
Page id: page_012
Page dir: F:\泉城实验室\二期\论文\异常检测\output\image-to-editable-ppt\20260706-212634-codex_ppt_园区网络流量智能检测与分析专题汇报\pages\page_012
Source image: F:\泉城实验室\二期\论文\异常检测\output\image-to-editable-ppt\20260706-212634-codex_ppt_园区网络流量智能检测与分析专题汇报\pages\page_012\source.png
...
- C:\Users\LongShine\.codex\skills\image-to-editable-ppt/references/page-decision-tree.md — the single source of truth for all object-source decisions: the three-step decision process, text-hints usage, the final self-check, and the fix-versus-warning split.
- C:\Users\LongShine\.codex\skills\image-to-editable-ppt/references/manifest-schema.md — the field contracts for manifest.json, validation.json, page_result.json, and imagegen-jobs.json.
- C:\Users\LongShine\.codex\skills\image-to-editable-ppt/references/cli-helper.md — editppt command syntax and examples.
...
6. Build the artifacts with the deterministic runtime: `editppt page build F:\泉城实验室\二期\论文\异常检测\output\image-to-editable-ppt\20260706-212634-codex_ppt_园区网络流量智能检测与分析专题汇报\pages\page_012` (writes page.pptx and preview.png from manifest.json), then `editppt page contact-sheet F:\泉城实验室\二期\论文\异常检测\output\image-to-editable-ppt\20260706-212634-codex_ppt_园区网络流量智能检测与分析专题汇报\pages\page_012`, then `editppt page validate F:\泉城实验室\二期\论文\异常检测\output\image-to-editable-ppt\20260706-212634-codex_ppt_园区网络流量智能检测与分析专题汇报\pages\page_012` — it runs the same manifest-contract checks `editppt run record` will run, so fix every reported issue here, inside the page.
